...
export default {
  name: 'getname',
  desc: 'Profile utility command for getname',
  category: 'profile',
  execute: async (sock, msg, args) => {
      ...
      if (!ownerCheck && 'getname'.includes('bot')) return sock.sendMessage(msg.key.remoteJid, { text: 'Owner only command!' });

      try {
         const box = createBox(botname, [
            formatLine('ᴀᴄᴛɪᴏɴ', 'getname'),
