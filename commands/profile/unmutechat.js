...
export default {
  name: 'unmutechat',
  desc: 'Profile utility command for unmutechat',
  category: 'profile',
  execute: async (sock, msg, args) => {
      ...
      if (!isOwner && 'unmutechat'.includes('bot')) return sock.sendMessage(msg.key.remoteJid, { text: 'Owner only command!' });

      try {
         const box = createBox(botname, [
            formatLine('ᴀᴄᴛɪᴏɴ', 'unmutechat'),
