...
export default {
  name: 'online',
  desc: 'Profile utility command for online',
  category: 'profile',
  execute: async (sock, msg, args) => {
      ...
      if (!ownerCheck && 'online'.includes('bot')) return sock.sendMessage(msg.key.remoteJid, { text: 'Owner only command!' });

      try {
         const box = createBox(botname, [
            formatLine('ᴀᴄᴛɪᴏɴ', 'online'),
