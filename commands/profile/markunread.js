...
export default {
  name: 'markunread',
  desc: 'Profile utility command for markunread',
  category: 'profile',
  execute: async (sock, msg, args) => {
      ...
      if (!ownerCheck && 'markunread'.includes('bot')) return sock.sendMessage(msg.key.remoteJid, { text: 'Owner only command!' });

      try {
         const box = createBox(botname, [
            formatLine('ᴀᴄᴛɪᴏɴ', 'markunread'),
