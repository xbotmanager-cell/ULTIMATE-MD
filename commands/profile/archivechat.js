...
export default {
  name: 'archivechat',
  desc: 'Profile utility command for archivechat',
  category: 'profile',
  execute: async (sock, msg, args) => {
      ...
      if (!ownerCheck && 'archivechat'.includes('bot')) return sock.sendMessage(msg.key.remoteJid, { text: 'Owner only command!' });

      try {
         const box = createBox(botname, [
            formatLine('ᴀᴄᴛɪᴏɴ', 'archivechat'),
