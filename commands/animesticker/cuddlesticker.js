...
export default {
  name: 'cuddlesticker',
  alias: ['cuddles', 'stccuddle'],
  desc: 'Pulls a cuddle sticker for chat domination!',
  ...
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        ...
        { url: `https://api.waifu.im/search?included_tags=cuddle`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/cuddle`, path: 'url' },
      ...
      await sock.sendMessage(msg.key.remoteJid, { 
        image: { url: finalUrl },
        caption: `${botname} | CUDDLE STICKER 🌟\n(${usedApi})`
      }, { quoted: msg });
