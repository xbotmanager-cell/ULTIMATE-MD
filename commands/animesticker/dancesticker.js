...
export default {
  name: 'dancesticker',
  alias: ['dances', 'stcdance'],
  desc: 'Pulls a dance sticker for chat domination!',
  ...
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        ...
        { url: `https://nekos.best/api/v2/dance`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=dance`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/dance`, path: 'url' },
