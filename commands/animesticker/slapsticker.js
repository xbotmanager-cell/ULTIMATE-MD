...
export default {
  name: 'slapsticker',
  alias: ['slaps', 'stcslap'],
  desc: 'Pulls a slap sticker for chat domination!',
  ...
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        ...
        { url: `https://api.waifu.im/search?included_tags=slap`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/slap`, path: 'url' },
