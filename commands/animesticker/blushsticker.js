...
export default {
  name: 'blushsticker',
  alias: ['blushs', 'stcblush'],
  desc: 'Pulls a blush sticker for chat domination!',
  category: 'animesticker',
  react: '🌟',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/blush`, path: 'url' },
        { url: `https://nekos.best/api/v2/blush`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=blush`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/blush`, path: 'url' },
