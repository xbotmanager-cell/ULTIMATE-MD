...
export default {
  name: 'frankysticker',
  alias: ['frankys', 'stcfranky'],
  desc: 'Pulls a franky sticker for chat domination!',
  category: 'animesticker',
  react: '🌟',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/franky`, path: 'url' },
        { url: `https://nekos.best/api/v2/franky`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=franky`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/franky`, path: 'url' },
      ...
      await sock.sendMessage(msg.key.remoteJid, { 
        image: { url: finalUrl },
        caption: `${botname} | FRANKY STICKER 🌟\n(${usedApi})`
      }, { quoted: msg });
