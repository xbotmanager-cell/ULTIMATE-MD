...
export default {
  name: 'highfivesticker',
  alias: ['highfives', 'stchighfive'],
  desc: 'Pulls a highfive sticker for chat domination!',
  category: 'animesticker',
  react: '🌟',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/highfive`, path: 'url' },
        { url: `https://nekos.best/api/v2/highfive`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=highfive`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/highfive`, path: 'url' },
      ...
      await sock.sendMessage(msg.key.remoteJid, { 
        image: { url: finalUrl },
        caption: `${botname} | HIGHFIVE STICKER 🌟\n(${usedApi})`
      }, { quoted: msg });
