...
export default {
  name: 'hinatasticker',
  alias: ['hinatas', 'stchinata'],
  desc: 'Pulls a hinata sticker for chat domination!',
  category: 'animesticker',
  react: '🌟',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/hinata`, path: 'url' },
        { url: `https://nekos.best/api/v2/hinata`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=hinata`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/hinata`, path: 'url' },
      ...
      await sock.sendMessage(msg.key.remoteJid, { 
        image: { url: finalUrl },
        caption: `${botname} | HINATA STICKER 🌟\n(${usedApi})`
      }, { quoted: msg });
