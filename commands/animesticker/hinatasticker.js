...
export default {
  ...
  desc: 'Pulls a 100% kawaii hinata sticker for chat domination!',
  ...
  execute: async (sock, msg, args) => {
    try {
      ...
      if (apiTypes.includes('hinata')) {
        try {
           const res = await axios.get(`https://api.waifu.pics/sfw/${'hinata'}`);
