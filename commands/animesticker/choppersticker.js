...
export default {
  name: 'choppersticker',
  alias: ['choppers', 'stcchopper'],
  desc: 'Pulls a chopper sticker for chat domination!',
  category: 'animesticker',
  react: '🌟',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/chopper`, path: 'url' },
        { url: `https://nekos.best/api/v2/chopper`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=chopper`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/chopper`, path: 'url' },
      ...
      await sock.sendMessage(msg.key.remoteJid, { 
        image: { url: finalUrl },
        caption: `${botname} | CHOPPER STICKER 🌟\n(${usedApi})`
      }, { quoted: msg });
