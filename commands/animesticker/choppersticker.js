...
export default {
  ...
  desc: 'Pulls a 100% kawaii chopper sticker for chat domination!',
  ...
  execute: async (sock, msg, args) => {
    try {
      ...
      if (apiTypes.includes('chopper')) {
        try {
           const res = await axios.get(`https://api.waifu.pics/sfw/${'chopper'}`);
