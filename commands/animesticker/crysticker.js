...
export default {
  name: 'crysticker',
  alias: ['crys', 'stccry'],
  desc: 'Pulls a cry sticker for chat domination!',
  category: 'animesticker',
  react: '🌟',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/cry`, path: 'url' },
        { url: `https://nekos.best/api/v2/cry`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=cry`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/cry`, path: 'url' },
