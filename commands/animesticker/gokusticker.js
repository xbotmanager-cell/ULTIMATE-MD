...
export default {
  name: 'gokusticker',
  alias: ['gokus', 'stcgoku'],
  desc: 'Pulls a goku sticker for chat domination!',
  category: 'animesticker',
  react: '🌟',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/goku`, path: 'url' },
        { url: `https://nekos.best/api/v2/goku`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=goku`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/goku`, path: 'url' },
