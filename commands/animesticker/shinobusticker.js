...
export default {
  name: 'shinobusticker',
  alias: ['shinobus', 'stcshinobu'],
  desc: 'Pulls a shinobu sticker for chat domination!',
  ...
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        ...
        { url: `https://nekos.best/api/v2/shinobu`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=shinobu`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/shinobu`, path: 'url' },
      ...
      await sock.sendMessage(msg.key.remoteJid, { 
        image: { url: finalUrl },
        caption: `${botname} | SHINOBU STICKER 🌟\n(${usedApi})`
      }, { quoted: msg });
