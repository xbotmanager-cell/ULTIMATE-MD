...
export default {
  name: 'smilesticker',
  alias: ['smiles', 'stcsmile'],
  desc: 'Pulls a smile sticker for chat domination!',
  category: 'animesticker',
  react: '🌟',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/smile`, path: 'url' },
        { url: `https://nekos.best/api/v2/smile`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=smile`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/smile`, path: 'url' },
