...
export default {
  name: 'sakurasticker',
  alias: ['sakuras', 'stcsakura'],
  desc: 'Pulls a sakura sticker for chat domination!',
  category: 'animesticker',
  react: '🌟',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/sakura`, path: 'url' },
        { url: `https://nekos.best/api/v2/sakura`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=sakura`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/sakura`, path: 'url' },
      ...
      await sock.sendMessage(msg.key.remoteJid, { 
        image: { url: finalUrl },
        caption: `${botname} | SAKURA STICKER 🌟\n(${usedApi})`
      }, { quoted: msg });
