...
export default {
  name: 'sasukesticker',
  alias: ['sasukes', 'stcsasuke'],
  desc: 'Pulls a sasuke sticker for chat domination!',
  category: 'animesticker',
  react: '🌟',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/sasuke`, path: 'url' },
        { url: `https://nekos.best/api/v2/sasuke`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=sasuke`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/sasuke`, path: 'url' },
      ...
      await sock.sendMessage(msg.key.remoteJid, { 
        image: { url: finalUrl },
        caption: `${botname} | SASUKE STICKER 🌟\n(${usedApi})`
      }, { quoted: msg });
