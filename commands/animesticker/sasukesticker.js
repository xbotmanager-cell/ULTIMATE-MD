...
export default {
  ...
  desc: 'Pulls a 100% kawaii sasuke sticker for chat domination!',
  ...
  execute: async (sock, msg, args) => {
    try {
      ...
      if (apiTypes.includes('sasuke')) {
        try {
           const res = await axios.get(`https://api.waifu.pics/sfw/${'sasuke'}`);
