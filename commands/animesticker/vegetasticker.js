...
export default {
  name: 'vegetasticker',
  alias: ['vegetas', 'stcvegeta'],
  desc: 'Pulls a vegeta sticker for chat domination!',
  category: 'animesticker',
  react: '🌟',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/vegeta`, path: 'url' },
        { url: `https://nekos.best/api/v2/vegeta`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=vegeta`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/vegeta`, path: 'url' },
      ...
      await sock.sendMessage(msg.key.remoteJid, { 
        image: { url: finalUrl },
        caption: `${botname} | VEGETA STICKER 🌟\n(${usedApi})`
      }, { quoted: msg });
