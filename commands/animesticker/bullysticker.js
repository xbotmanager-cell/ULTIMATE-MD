...
export default {
  name: 'bullysticker',
  alias: ['bullys', 'stcbully'],
  desc: 'Pulls a bully sticker for chat domination!',
  category: 'animesticker',
  react: '🌟',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/bully`, path: 'url' },
        { url: `https://nekos.best/api/v2/bully`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=bully`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/bully`, path: 'url' },
