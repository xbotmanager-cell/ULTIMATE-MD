...
export default {
  name: 'kakashisticker',
  alias: ['kakashis', 'stckakashi'],
  desc: 'Pulls a kakashi sticker for chat domination!',
  category: 'animesticker',
  react: '🌟',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/kakashi`, path: 'url' },
        { url: `https://nekos.best/api/v2/kakashi`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=kakashi`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/kakashi`, path: 'url' },
      ...
      await sock.sendMessage(msg.key.remoteJid, { 
        image: { url: finalUrl },
        caption: `${botname} | KAKASHI STICKER 🌟\n(${usedApi})`
      }, { quoted: msg });
