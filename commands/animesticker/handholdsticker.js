...
export default {
  name: 'handholdsticker',
  alias: ['handholds', 'stchandhold'],
  desc: 'Pulls a handhold sticker for chat domination!',
  category: 'animesticker',
  react: '🌟',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/handhold`, path: 'url' },
        { url: `https://nekos.best/api/v2/handhold`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=handhold`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/handhold`, path: 'url' },
      ...
      await sock.sendMessage(msg.key.remoteJid, { 
        image: { url: finalUrl },
        caption: `${botname} | HANDHOLD STICKER 🌟\n(${usedApi})`
      }, { quoted: msg });
