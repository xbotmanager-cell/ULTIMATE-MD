...
export default {
  name: 'meguminsticker',
  alias: ['megumins', 'stcmegumin'],
  desc: 'Pulls a megumin sticker for chat domination!',
  ...
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        ...
        { url: `https://nekos.best/api/v2/megumin`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=megumin`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/megumin`, path: 'url' },
      ...
      await sock.sendMessage(msg.key.remoteJid, { 
        image: { url: finalUrl },
        caption: `${botname} | MEGUMIN STICKER 🌟\n(${usedApi})`
      }, { quoted: msg });
