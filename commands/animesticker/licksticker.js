...
export default {
  name: 'licksticker',
  alias: ['licks', 'stclick'],
  desc: 'Pulls a lick sticker for chat domination!',
  category: 'animesticker',
  react: '🌟',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/lick`, path: 'url' },
        { url: `https://nekos.best/api/v2/lick`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=lick`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/lick`, path: 'url' },
