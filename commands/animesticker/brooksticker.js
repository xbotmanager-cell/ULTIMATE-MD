...
export default {
  name: 'brooksticker',
  alias: ['brooks', 'stcbrook'],
  desc: 'Pulls a brook sticker for chat domination!',
  category: 'animesticker',
  react: '🌟',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/brook`, path: 'url' },
        { url: `https://nekos.best/api/v2/brook`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=brook`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/brook`, path: 'url' },
