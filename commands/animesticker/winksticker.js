...
export default {
  name: 'winksticker',
  alias: ['winks', 'stcwink'],
  desc: 'Pulls a wink sticker for chat domination!',
  category: 'animesticker',
  react: '🌟',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/wink`, path: 'url' },
        { url: `https://nekos.best/api/v2/wink`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=wink`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/wink`, path: 'url' },
