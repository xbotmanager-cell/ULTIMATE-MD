...
export default {
  name: 'narutosticker',
  alias: ['narutos', 'stcnaruto'],
  desc: 'Pulls a naruto sticker for chat domination!',
  category: 'animesticker',
  react: '🌟',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/naruto`, path: 'url' },
        { url: `https://nekos.best/api/v2/naruto`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=naruto`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/naruto`, path: 'url' },
      ...
      await sock.sendMessage(msg.key.remoteJid, { 
        image: { url: finalUrl },
        caption: `${botname} | NARUTO STICKER 🌟\n(${usedApi})`
      }, { quoted: msg });
