...
export default {
  name: 'piccolosticker',
  alias: ['piccolos', 'stcpiccolo'],
  desc: 'Pulls a piccolo sticker for chat domination!',
  category: 'animesticker',
  react: '🌟',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/piccolo`, path: 'url' },
        { url: `https://nekos.best/api/v2/piccolo`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=piccolo`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/piccolo`, path: 'url' },
      ...
      await sock.sendMessage(msg.key.remoteJid, { 
        image: { url: finalUrl },
        caption: `${botname} | PICCOLO STICKER 🌟\n(${usedApi})`
      }, { quoted: msg });
