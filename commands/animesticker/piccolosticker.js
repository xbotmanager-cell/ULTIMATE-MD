...
export default {
  ...
  desc: 'Pulls a 100% kawaii piccolo sticker for chat domination!',
  ...
  execute: async (sock, msg, args) => {
    try {
      ...
      if (apiTypes.includes('piccolo')) {
        try {
           const res = await axios.get(`https://api.waifu.pics/sfw/${'piccolo'}`);
