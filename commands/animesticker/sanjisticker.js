...
export default {
  name: 'sanjisticker',
  alias: ['sanjis', 'stcsanji'],
  desc: 'Pulls a sanji sticker for chat domination!',
  category: 'animesticker',
  react: '🌟',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/sanji`, path: 'url' },
        { url: `https://nekos.best/api/v2/sanji`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=sanji`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/sanji`, path: 'url' },
