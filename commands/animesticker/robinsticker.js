...
export default {
  name: 'robinsticker',
  alias: ['robins', 'stcrobin'],
  desc: 'Pulls a robin sticker for chat domination!',
  category: 'animesticker',
  react: '🌟',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/robin`, path: 'url' },
        { url: `https://nekos.best/api/v2/robin`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=robin`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/robin`, path: 'url' },
