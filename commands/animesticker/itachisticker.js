...
export default {
  name: 'itachisticker',
  alias: ['itachis', 'stcitachi'],
  desc: 'Pulls a itachi sticker for chat domination!',
  category: 'animesticker',
  react: '🌟',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/itachi`, path: 'url' },
        { url: `https://nekos.best/api/v2/itachi`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=itachi`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/itachi`, path: 'url' },
      ...
      await sock.sendMessage(msg.key.remoteJid, { 
        image: { url: finalUrl },
        caption: `${botname} | ITACHI STICKER 🌟\n(${usedApi})`
      }, { quoted: msg });
