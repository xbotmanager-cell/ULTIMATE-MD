...
export default {
  name: 'luffysticker',
  alias: ['luffys', 'stcluffy'],
  desc: 'Pulls a luffy sticker for chat domination!',
  category: 'animesticker',
  react: '🌟',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/luffy`, path: 'url' },
        { url: `https://nekos.best/api/v2/luffy`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=luffy`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/luffy`, path: 'url' },
