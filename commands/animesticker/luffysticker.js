...
export default {
  ...
  desc: 'Pulls a 100% kawaii luffy sticker for chat domination!',
  ...
  execute: async (sock, msg, args) => {
    try {
      ...
      if (apiTypes.includes('luffy')) {
        try {
           const res = await axios.get(`https://api.waifu.pics/sfw/${'luffy'}`);
