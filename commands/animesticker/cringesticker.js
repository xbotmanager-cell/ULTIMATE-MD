...
export default {
  name: 'cringesticker',
  alias: ['cringes', 'stccringe'],
  desc: 'Pulls a cringe sticker for chat domination!',
  ...
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        ...
        { url: `https://nekos.best/api/v2/cringe`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=cringe`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/cringe`, path: 'url' },
      ...
      await sock.sendMessage(msg.key.remoteJid, { 
        image: { url: finalUrl },
        caption: `${botname} | CRINGE STICKER 🌟\n(${usedApi})`
      }, { quoted: msg });
