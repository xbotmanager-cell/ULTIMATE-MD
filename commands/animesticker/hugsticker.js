...
export default {
  name: 'hugsticker',
  alias: ['hugs', 'stchug'],
  desc: 'Pulls a hug sticker for chat domination!',
  ...
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        ...
        { url: `https://api.waifu.im/search?included_tags=hug`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/hug`, path: 'url' },
