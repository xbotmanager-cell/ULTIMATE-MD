...
export default {
  ...
  desc: 'Pulls a 100% kawaii usopp sticker for chat domination!',
  ...
  execute: async (sock, msg, args) => {
    try {
      ...
      if (apiTypes.includes('usopp')) {
        try {
           const res = await axios.get(`https://api.waifu.pics/sfw/${'usopp'}`);
