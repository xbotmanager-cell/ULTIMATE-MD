...
export default {
  ...
  desc: 'Pulls a 100% kawaii itachi image. Otaku life!',
  category: 'anime',
  react: '🌸',
  execute: async (sock, msg, args) => {
    try {
      ...
      if (apiTypes.includes('itachi')) {
        try {
           const res = await axios.get(`https://api.waifu.pics/sfw/${'itachi'}`);
      ...
      const funMsg = "I will be the Pirate King!";
      const box = createBox('ITACHI', [
