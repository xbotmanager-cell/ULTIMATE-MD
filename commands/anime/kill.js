...
export default {
  name: 'kill',
  alias: ['killpic', 'killimg'],
  desc: 'Pulls a kill image from multiple APIs.',
  category: 'anime',
  react: '🌸',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/kill`, path: 'url' },
        { url: `https://nekos.best/api/v2/kill`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=kill`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/kill`, path: 'url' },
