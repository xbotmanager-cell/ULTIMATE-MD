...
export default {
  name: 'wave',
  alias: ['wavepic', 'waveimg'],
  desc: 'Pulls a wave image from multiple APIs.',
  category: 'anime',
  react: '🌸',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/wave`, path: 'url' },
        { url: `https://nekos.best/api/v2/wave`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=wave`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/wave`, path: 'url' },
