...
export default {
  name: 'awoo',
  alias: ['awoopic', 'awooimg'],
  desc: 'Pulls a awoo image from multiple APIs.',
  category: 'anime',
  react: '🌸',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/awoo`, path: 'url' },
        { url: `https://nekos.best/api/v2/awoo`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=awoo`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/awoo`, path: 'url' },
