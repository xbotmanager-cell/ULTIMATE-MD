...
export default {
  name: 'happy',
  alias: ['happypic', 'happyimg'],
  desc: 'Pulls a happy image from multiple APIs.',
  category: 'anime',
  react: '🌸',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/happy`, path: 'url' },
        { url: `https://nekos.best/api/v2/happy`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=happy`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/happy`, path: 'url' },
