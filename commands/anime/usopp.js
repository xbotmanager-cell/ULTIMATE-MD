...
export default {
  name: 'usopp',
  alias: ['usopppic', 'usoppimg'],
  desc: 'Pulls a usopp image from multiple APIs.',
  category: 'anime',
  react: '🌸',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/usopp`, path: 'url' },
        { url: `https://nekos.best/api/v2/usopp`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=usopp`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/usopp`, path: 'url' },
