...
export default {
  name: 'nami',
  alias: ['namipic', 'namiimg'],
  desc: 'Pulls a nami image from multiple APIs.',
  category: 'anime',
  react: '🌸',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/nami`, path: 'url' },
        { url: `https://nekos.best/api/v2/nami`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=nami`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/nami`, path: 'url' },
