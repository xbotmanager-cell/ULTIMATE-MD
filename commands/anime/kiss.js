...
export default {
  name: 'kiss',
  alias: ['kisspic', 'kissimg'],
  desc: 'Pulls a kiss image from multiple APIs.',
  category: 'anime',
  react: '🌸',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        ...
        { url: `https://api.waifu.im/search?included_tags=kiss`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/kiss`, path: 'url' },
