...
export default {
  name: 'zoro',
  alias: ['zoropic', 'zoroimg'],
  desc: 'Pulls a zoro image from multiple APIs.',
  category: 'anime',
  react: '🌸',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/zoro`, path: 'url' },
        { url: `https://nekos.best/api/v2/zoro`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=zoro`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/zoro`, path: 'url' },
