...
export default {
  name: 'bite',
  alias: ['bitepic', 'biteimg'],
  desc: 'Pulls a bite image from multiple APIs.',
  category: 'anime',
  react: '🌸',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        ...
        { url: `https://nekos.best/api/v2/bite`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=bite`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/bite`, path: 'url' },
