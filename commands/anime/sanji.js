...
export default {
  ...
  desc: 'Pulls a 100% kawaii sanji image. Otaku life!',
  category: 'anime',
  react: '🌸',
  execute: async (sock, msg, args) => {
    try {
      ...
      if (apiTypes.includes('sanji')) {
        try {
           const res = await axios.get(`https://api.waifu.pics/sfw/${'sanji'}`);
