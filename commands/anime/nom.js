...
export default {
  name: 'nom',
  alias: ['nompic', 'nomimg'],
  desc: 'Pulls a nom image from multiple APIs.',
  category: 'anime',
  react: '🌸',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/nom`, path: 'url' },
        { url: `https://nekos.best/api/v2/nom`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=nom`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/nom`, path: 'url' },
