...
export default {
  name: 'yeet',
  alias: ['yeetpic', 'yeetimg'],
  desc: 'Pulls a yeet image from multiple APIs.',
  category: 'anime',
  react: '🌸',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/yeet`, path: 'url' },
        { url: `https://nekos.best/api/v2/yeet`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=yeet`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/yeet`, path: 'url' },
