...
export default {
  name: 'smug',
  alias: ['smugpic', 'smugimg'],
  desc: 'Pulls a smug image from multiple APIs.',
  category: 'anime',
  react: '🌸',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/smug`, path: 'url' },
        { url: `https://nekos.best/api/v2/smug`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=smug`, path: 'images.0.url' },
