...
export default {
  name: 'bonk',
  alias: ['bonkpic', 'bonkimg'],
  desc: 'Pulls a bonk image from multiple APIs.',
  category: 'anime',
  react: '🌸',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/bonk`, path: 'url' },
        { url: `https://nekos.best/api/v2/bonk`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=bonk`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/bonk`, path: 'url' },
