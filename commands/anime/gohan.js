...
export default {
  name: 'gohan',
  alias: ['gohanpic', 'gohanimg'],
  desc: 'Pulls a gohan image from multiple APIs.',
  category: 'anime',
  react: '🌸',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/gohan`, path: 'url' },
        { url: `https://nekos.best/api/v2/gohan`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=gohan`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/gohan`, path: 'url' },
