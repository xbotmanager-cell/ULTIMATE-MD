...
export default {
  name: 'poke',
  alias: ['pokepic', 'pokeimg'],
  desc: 'Pulls a poke image from multiple APIs.',
  category: 'anime',
  react: '🌸',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/poke`, path: 'url' },
        { url: `https://nekos.best/api/v2/poke`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=poke`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/poke`, path: 'url' },
