...
export default {
  name: 'kick',
  alias: ['kickpic', 'kickimg'],
  desc: 'Pulls a kick image from multiple APIs.',
  category: 'anime',
  react: '🌸',
  execute: async (sock, msg, args) => {
    try {
      const apiSources = [
        { url: `https://api.waifu.pics/sfw/kick`, path: 'url' },
        { url: `https://nekos.best/api/v2/kick`, path: 'results.0.url' },
        { url: `https://api.waifu.im/search?included_tags=kick`, path: 'images.0.url' },
        { url: `https://nekos.life/api/v2/img/kick`, path: 'url' },
