...
export default {
  ...
  desc: 'Pulls a 100% kawaii robin image. Otaku life!',
  category: 'anime',
  react: '🌸',
  execute: async (sock, msg, args) => {
    try {
      ...
      if (apiTypes.includes('robin')) {
        try {
           const res = await axios.get(`https://api.waifu.pics/sfw/${'robin'}`);
