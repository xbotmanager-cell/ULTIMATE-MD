...
export default {
  name: 'telegramstalk',
  alias: ['stalktelegram'],
  desc: 'Stalk profile for telegram',
  category: 'stalker',
  execute: async (sock, msg, args) => {
      try {
         ...
         const target = cmd === 'githubstalk' ? 'github' : 'telegram';
         const apiSources = [];
         ...
         await sock.sendMessage(msg.key.remoteJid, { text: 'Error in telegramstalk.' }, { quoted: msg });
      }
  }
};
