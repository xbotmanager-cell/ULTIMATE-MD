...
export default {
  name: 'snapchatstalk',
  alias: ['stalksnapchat'],
  desc: 'Stalk profile for snapchat',
  category: 'stalker',
  execute: async (sock, msg, args) => {
      try {
         ...
         const target = cmd === 'githubstalk' ? 'github' : 'snapchat';
         const apiSources = [];
         ...
         await sock.sendMessage(msg.key.remoteJid, { text: 'Error in snapchatstalk.' }, { quoted: msg });
      }
  }
};
