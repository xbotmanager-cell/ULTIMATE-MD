...
export default {
  name: 'twitterstalk',
  alias: ['stalktwitter'],
  desc: 'Stalk profile for twitter',
  category: 'stalker',
  execute: async (sock, msg, args) => {
      try {
         ...
         const target = cmd === 'githubstalk' ? 'github' : 'twitter';
         const apiSources = [];
         ...
         await sock.sendMessage(msg.key.remoteJid, { text: 'Error in twitterstalk.' }, { quoted: msg });
      }
  }
};
