  ...
  execute: async (sock, msg, args) => {
      try {
         ...
         if ('movie' === 'movie') {
             ...
             try {
                const res = await axios.get(`https://api.jikan.moe/v4/movie?q=${encodeURIComponent(query)}&limit=1`);
