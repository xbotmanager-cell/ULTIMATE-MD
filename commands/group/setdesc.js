...
export default {
  ...
  execute: async (sock, msg, args) => {
    try {
      ...
      if (!newDesc) return sock.sendMessage(msg.key.remoteJid, { text: 'Provide a new description.' }, { quoted: msg });
      await sock.groupUpdateDescription(msg.key.remoteJid, newDesc);
      
      const box = createBox('ᴅᴇsᴄ ᴄʜᴀɴɢᴇᴅ', [
        formatLine('ɴᴇᴡ', newDesc),
        formatLine('sᴛᴀᴛᴜs', 'Words to live by!')
      ]);
