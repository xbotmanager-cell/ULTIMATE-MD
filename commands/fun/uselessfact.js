...
export default {
  name: 'uselessfact',
  desc: 'Fun command to get random uselessfact',
  category: 'fun',
  execute: async (sock, msg, args) => {
      try {
         ...
         await sock.sendMessage(msg.key.remoteJid, { text: 'Yikes, executing uselessfact went completely sideways 😂.' }, { quoted: msg });
      }
  }
};
