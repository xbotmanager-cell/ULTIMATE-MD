...
export default {
  name: 'dogfact',
  desc: 'Fun command to get random dogfact',
  category: 'fun',
  execute: async (sock, msg, args) => {
      try {
         ...
         await sock.sendMessage(msg.key.remoteJid, { text: 'Yikes, executing dogfact went completely sideways 😂.' }, { quoted: msg });
      }
  }
};
