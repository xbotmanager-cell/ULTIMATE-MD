...
export default {
  name: 'hacker',
  desc: 'Fun command to get random hacker',
  category: 'fun',
  execute: async (sock, msg, args) => {
      try {
         ...
         await sock.sendMessage(msg.key.remoteJid, { text: 'Yikes, executing hacker went completely sideways 😂.' }, { quoted: msg });
      }
  }
};
