...
export default {
  name: 'pickup',
  desc: 'Fun command to get random pickup',
  category: 'fun',
  execute: async (sock, msg, args) => {
      try {
         ...
         await sock.sendMessage(msg.key.remoteJid, { text: 'Yikes, executing pickup went completely sideways 😂.' }, { quoted: msg });
      }
  }
};
