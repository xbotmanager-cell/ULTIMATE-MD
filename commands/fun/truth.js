...
export default {
  name: 'truth',
  desc: 'Fun command to get random truth',
  category: 'fun',
  execute: async (sock, msg, args) => {
      try {
         ...
         await sock.sendMessage(msg.key.remoteJid, { text: 'Yikes, executing truth went completely sideways 😂.' }, { quoted: msg });
      }
  }
};
