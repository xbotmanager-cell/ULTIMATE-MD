...
export default {
  name: 'roast',
  desc: 'Fun command to get random roast',
  category: 'fun',
  execute: async (sock, msg, args) => {
      try {
         ...
         await sock.sendMessage(msg.key.remoteJid, { text: 'Yikes, executing roast went completely sideways 😂.' }, { quoted: msg });
      }
  }
};
