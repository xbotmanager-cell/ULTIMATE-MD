...
export default {
  name: 'horoscope',
  desc: 'Fun command to get random horoscope',
  category: 'fun',
  execute: async (sock, msg, args) => {
      try {
         ...
         await sock.sendMessage(msg.key.remoteJid, { text: 'Yikes, executing horoscope went completely sideways 😂.' }, { quoted: msg });
      }
  }
};
