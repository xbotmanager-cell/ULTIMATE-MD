...
export default {
  name: 'advice',
  desc: 'Fun command to get random advice',
  category: 'fun',
  execute: async (sock, msg, args) => {
      try {
         ...
         await sock.sendMessage(msg.key.remoteJid, { text: 'Yikes, executing advice went completely sideways 😂.' }, { quoted: msg });
      }
  }
};
