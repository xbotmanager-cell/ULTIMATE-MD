...
export default {
  name: 'quote',
  desc: 'Fun command to get random quote',
  category: 'fun',
  execute: async (sock, msg, args) => {
      try {
         ...
         await sock.sendMessage(msg.key.remoteJid, { text: 'Yikes, executing quote went completely sideways 😂.' }, { quoted: msg });
      }
  }
};
