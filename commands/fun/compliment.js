...
export default {
  name: 'compliment',
  desc: 'Fun command to get random compliment',
  category: 'fun',
  execute: async (sock, msg, args) => {
      try {
         ...
         await sock.sendMessage(msg.key.remoteJid, { text: 'Yikes, executing compliment went completely sideways 😂.' }, { quoted: msg });
      }
  }
};
