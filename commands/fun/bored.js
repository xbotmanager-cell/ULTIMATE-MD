...
export default {
  name: 'bored',
  desc: 'Fun command to get random bored',
  category: 'fun',
  execute: async (sock, msg, args) => {
      try {
         ...
         await sock.sendMessage(msg.key.remoteJid, { text: 'Yikes, executing bored went completely sideways 😂.' }, { quoted: msg });
      }
  }
};
