...
export default {
  name: 'catfact',
  desc: 'Fun command to get random catfact',
  category: 'fun',
  execute: async (sock, msg, args) => {
      try {
         ...
         await sock.sendMessage(msg.key.remoteJid, { text: 'Yikes, executing catfact went completely sideways 😂.' }, { quoted: msg });
      }
  }
};
