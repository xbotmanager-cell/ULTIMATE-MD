...
export default {
  ...
  execute: async (sock, msg, args) => {
      try {
         ...
         await sock.sendMessage(msg.key.remoteJid, { text: 'Yikes, executing play went completely sideways 😂.' }, { quoted: msg });
      }
  }
};
