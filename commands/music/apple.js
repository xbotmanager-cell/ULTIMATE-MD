...
export default {
  ...
  desc: 'Search and download apple',
  category: 'music',
  execute: async (sock, msg, args) => {
      try {
         ...
         await sock.sendMessage(msg.key.remoteJid, { text: 'Yikes, executing apple went completely sideways 😂.' }, { quoted: msg });
      }
  }
};
