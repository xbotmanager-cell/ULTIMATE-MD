...
export default {
  ...
  desc: 'Search and download soundcloud',
  category: 'music',
  execute: async (sock, msg, args) => {
      try {
         ...
         await sock.sendMessage(msg.key.remoteJid, { text: 'Yikes, executing soundcloud went completely sideways 😂.' }, { quoted: msg });
      }
  }
};
