...
export default {
  ...
  desc: 'Search and download shazam',
  category: 'music',
  execute: async (sock, msg, args) => {
      try {
         ...
         await sock.sendMessage(msg.key.remoteJid, { text: 'Yikes, executing shazam went completely sideways 😂.' }, { quoted: msg });
      }
  }
};
