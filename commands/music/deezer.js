...
export default {
  ...
  desc: 'Search and download deezer',
  category: 'music',
  execute: async (sock, msg, args) => {
      try {
         ...
         await sock.sendMessage(msg.key.remoteJid, { text: 'Yikes, executing deezer went completely sideways 😂.' }, { quoted: msg });
      }
  }
};
