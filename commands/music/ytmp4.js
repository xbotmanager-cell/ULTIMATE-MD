...
export default {
  ...
  desc: 'Search and download ytmp4',
  category: 'music',
  execute: async (sock, msg, args) => {
      try {
         ...
         await sock.sendMessage(msg.key.remoteJid, { text: 'Yikes, executing ytmp4 went completely sideways 😂.' }, { quoted: msg });
      }
  }
};
