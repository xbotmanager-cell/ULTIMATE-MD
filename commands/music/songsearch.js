...
export default {
  ...
  desc: 'Search and download songsearch',
  category: 'music',
  execute: async (sock, msg, args) => {
      try {
         ...
         await sock.sendMessage(msg.key.remoteJid, { text: 'Yikes, executing songsearch went completely sideways 😂.' }, { quoted: msg });
      }
  }
};
