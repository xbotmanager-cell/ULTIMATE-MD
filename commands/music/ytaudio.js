...
export default {
  ...
  desc: 'Search and download ytaudio',
  category: 'music',
  execute: async (sock, msg, args) => {
      try {
         ...
         await sock.sendMessage(msg.key.remoteJid, { text: 'Yikes, executing ytaudio went completely sideways 😂.' }, { quoted: msg });
      }
  }
};
