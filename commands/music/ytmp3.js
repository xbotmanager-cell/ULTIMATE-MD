...
export default {
  ...
  desc: 'Search and download ytmp3',
  category: 'music',
  execute: async (sock, msg, args) => {
      try {
         ...
         await sock.sendMessage(msg.key.remoteJid, { text: 'Yikes, executing ytmp3 went completely sideways 😂.' }, { quoted: msg });
      }
  }
};
