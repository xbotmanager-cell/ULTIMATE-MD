...
export default {
  ...
  desc: 'Search and download lyrics',
  category: 'music',
  execute: async (sock, msg, args) => {
      try {
         ...
         await sock.sendMessage(msg.key.remoteJid, { text: 'Yikes, executing lyrics went completely sideways 😂.' }, { quoted: msg });
      }
  }
};
